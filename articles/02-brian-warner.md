...
It tends to be escaping things, or making assumptions about where data comes from, and how much an attacker gets control over if it that turns out to be faulty.
